...
#define HOOKSELF_BUILTIN_RULE_PROC_STAT_VIEW 0xffff0007U
#define HOOKSELF_BUILTIN_RULE_PROC_WCHAN_VIEW 0xffff0008U
...
enum HookselfEventFlags {
    ...
    HOOKSELF_EVENT_F_PROC_STAT_VIEW = 1U << 15,
    HOOKSELF_EVENT_F_PROC_WCHAN_VIEW = 1U << 16,
};
